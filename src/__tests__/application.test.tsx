...
describe("useInfiniteQuery hook", () => {
  ...
  it("Join tests", async () => {
    ...
    //     payload: postComment1.comments,
    //     model
    //   }),
    //   {
    //     comment: operation.join()
    //   },
    //   null
    // )

    // expect(typeof (cacheTest as any)[0].comment).toBe("string")
